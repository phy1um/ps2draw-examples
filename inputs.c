...
int sys_init_input() {
  ...
  ERR_IF_NULL(SifLoadModule(R_SIO2MAN, 0, 0), "Failed to load %s sif",
              R_SIO2MAN);
...
int in_btn_held(int b) { return btn_held[b]; }
int in_btn_pressed(int b) { return btn_press[b]; }
int in_btn_release(int b) { return btn_release[b]; }

unsigned char *in_joystick_state() { return joysticks; }
