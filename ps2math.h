...
#define logm4f(msg, model) printf("%s [ \n[%0.2f,%0.2f,%0.2f,%0.2f] \n[%0.2f,%0.2f,%0.2f,%0.2f] \n[%0.2f,%0.2f,%0.2f,%0.2f] \n[%0.2f,%0.2f,%0.2f,%0.2f ]", msg,\
...
#define setv4(v, x,y,z,w) do{v[0]=x;v[1]=y;v[2]=z;v[3]=w;}while(0)
#define setv3(a, x, y, z) do{a[0]=x;a[1]=y;a[2]=z;}while(0)

#define copyv3fto(a, b) do{b[0]=a[0]; b[1]=a[1]; b[2]=a[2];}while(0)
...
#define clampz(x) do{x = x < 0 ? 0 : x;}while(0)
